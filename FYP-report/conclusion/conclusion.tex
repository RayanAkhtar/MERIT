...
ranks as hypotheses, and not as the final decision. Treating MERIT as an oracle is not recommended, not only because of the potential for automation
...
In our project we were able to validate the feasibility of the prototype by using skill-extraction $F_1$, Spearman~$\rho$, and usability scores as indicators.
