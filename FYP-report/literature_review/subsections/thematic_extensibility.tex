...
\subsection{Semantic Skill Inference}
...
required competencies. This helps to surface skills that a recruiter may not have listed explicitly.
...
\subsection{LLM-Assisted Modular Screening}
...
a particular role, nor do they suggest weights based on the context of the job description.

\subsection{Corpus-Level Term Weighting}
...
the importance of a term based on its appearance within a document compared to its appearance throughout a 
corpus of documents. If a term is emphasised heavily in a document relative to the corpus, it will receive a 
higher ranking due to its rarity within the corpus. In a similar fashion, terms that are abundant within the
corpus are down-weighted due to a larger IDF. This is similar to large-scale skill inference from professional 
