...
to highlight a subset of specific behaviours for the purpose of a thorough evaluation. To mitigate positive selection bias, we deliberately 
constructed adversarial edge-cases designed to stress-test the system's boundaries and trigger known failure modes, ensuring a balanced evaluation. 
The use of synthetic data was necessitated by the strict privacy and anonymisation constraints surrounding real-world candidate data.
