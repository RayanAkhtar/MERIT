\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption[Data Extraction Pipeline]{A diagram showing the process of data extraction. 
    We decompose the unstructured document (CV) and structured API outputs (GitHub/LinkedIn) into
    a unified, queryable schema.}
