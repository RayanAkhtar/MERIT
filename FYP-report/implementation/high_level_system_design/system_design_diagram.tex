\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node [arch_logic, right=2.2cm of fusion, yshift=1.6cm] (run) {Candidate Ranking System};
        ...
        \node [domain_label, fill=white, inner sep=2pt] at (area1.north) {I. DATA EXTRACTION \& JOB CONFIGURATION};
        \node [domain_label, fill=white, inner sep=2pt] at (area2.north) {II. MULTI-SOURCE FUSION};
        \node [domain_label, fill=white, inner sep=2pt] at (area3.north) {III. EXPLAINABLE INTERPRETATION};

    \end{tikzpicture}
    \caption[MERIT three-stage architecture]{MERIT high-level architecture: extraction, fusion, and explainability.}
