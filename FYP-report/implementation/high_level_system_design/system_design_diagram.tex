\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node [domain_label, fill=white, inner sep=2pt] at (area1.north) {I. INTELLIGENT CONFIGURATION};
        \node [domain_label, fill=white, inner sep=2pt] at (area2.north) {II. EVIDENCE FUSION};
        \node [domain_label, fill=white, inner sep=2pt] at (area3.north) {III. EXPLAINABLE INTERPRETATION};

    \end{tikzpicture}
    \caption{High-Level System Design: The three stages of MERIT.}
