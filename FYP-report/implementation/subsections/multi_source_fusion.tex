...
Appendix~\ref{appendix:implementation_listings} demonstrates a truncated representation of this
architecture in practice. By exposing this data in a candidate's report, we are able to justify the
