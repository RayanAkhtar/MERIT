...
for a given source $i$, we sum the marginal contributions of that source across all of the coalitions that it is a part of.
Formally, this is given by the following equation:

\begin{equation}
    \phi_i = \sum_{S \subseteq N \setminus \{i\}} \frac{|S|! (n - |S| - 1)!}{n!} [v(S \cup \{i\}) - v(S)]
\end{equation}

The left side of the equation is the combinatorial weighting factor, which is the number of ways to choose $i$ sources from $n$ sources.
The right side of the equation is the marginal contribution of the source $i$ to the coalition $S$.
...
transparency is a focus of MERIT to allow recruiters to identity and override any algorithmic edge cases, or perhaps
...
as a metric, but the candidate may have Jupyter Notebook listed in their GitHub section of this view. If the semantic bridge mechanism fails to 
