...
As mentioned in the previous section, Bayesian Evidence Fusion not only provides an expected value, but also a variance, in other words,
...
We defined how variance is computed in Section~\ref{subsec:bayesian-fusion}. We build upon this by now computing 
the confidence interval for that candidate's score.
...
in the previous section. We map $\sigma$ to a traffic-light badge system (Green for High, Amber for Medium, Red for Low),
