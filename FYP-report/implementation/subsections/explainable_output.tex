...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.48\textwidth,height=0.34\textheight,keepaspectratio]{implementation/screenshots/candidate_rankings_dashboard.png}%
    \hfill
    \includegraphics[width=0.48\textwidth,height=0.34\textheight,keepaspectratio]{implementation/screenshots/metric_insights_panel.png}
