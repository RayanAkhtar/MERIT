...
\begin{figure}[htpb]
    ...
    \caption[Source Influence Breakdown panel]{Source influence breakdown with per-source Shapley values.}
...
The panel links to the full audit trail (per-source signals, Bayesian fusion, and Shapley breakdown) and surfaces actionable guidance where scores are limited. To further aid transparency,
...
\begin{figure}[htpb]
    ...
    \caption[Intelligence Report dashboard]{Intelligence Report ranking dashboard for a configuration.}
...
\begin{figure}[htpb]
    ...
    \caption[Metric Insights panel (Python)]{Metric Insights panel (example: Python) with confidence badge and audit trail.}
