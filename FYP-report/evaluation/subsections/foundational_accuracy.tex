...
by Gugnani, Misra and Lo et al.~\cite{gugnani2020,lo2025aihiring}. Graphical representations for this section are 
...
The previous two studies evaluate the extraction side of the extensibility pillar. In this study, we evaluate the weighting (or priority)
side of RQ1: whether TF-IDF-derived metric priorities adapt to role-specific JDs more flexibly than the fixed coefficient schemes criticised in prior work.
We measure TF-IDF suggestions against recruiter consensus to see how well our engine's predictions align with real-world recruiters.
