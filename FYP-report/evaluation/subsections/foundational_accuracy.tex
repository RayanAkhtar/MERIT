...
have also highlighted that opaque screening workflows can encourage parser-friendly CV formatting over 
verifiable competence, which is consistent with the parsing failures we observed.
...
hold-out metrics, a side-by-side consensus-vs.-TF-IDF scatter and Senior ML rater-weight heatmap, per-role dumbbell plots (blue = TF-IDF, gold = consensus),
and largest misalignments.
