...
We first evaluate the accuracy of the CV parser, extractive candidate data from 15 single-column CVs. We also
replicate this data across 15 multi-column CVs, ensuring that the content is the same for a given candidate,
to also evaluate the impact of a CV's layout on the accuracy of the parser. The CV's are designed to be diverse
...
an image, and is therefore forced to rely on the ``About Us section''. If the name is not present in this section, or 
