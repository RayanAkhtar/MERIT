...
This section addresses \textbf{RQ3}: whether Shapley attributions and a glass-box recruiter interface 
improve auditability and decision calibration relative to black-box scores.
Policy reviews document a transparency deficit in algorithmic hiring~\cite{bogen2018,raghavan2020}. 
Study~11 applies the coalition Shapley formalism from explainable ML~\cite{lundberg2017unified} at the 
data-source level (Section~\ref{sec:explainable-ai-shapley}).
...
before/after test of whether recruiters reverse shortlist decisions once explanations are shown. Our Decision Reversal 
Rate (DRR) metric targets that gap.
