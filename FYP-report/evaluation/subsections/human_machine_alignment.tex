...
\begin{table}[htbp]
    ...
    \begin{tabular}{l|c|c|c|c}
        ...
        MERIT (Full)    & \textbf{0.6970} ($p{=}0.025$) & \textbf{$-$0.5152 ($p{=}0.128$)} & 0.6242 ($p{=}0.054$) & 0.0061 ($p{=}0.987$) \\
        \hline
    \end{tabular}
\end{table}
...
MERIT (Full) achieves the strongest expert alignment ($\rho=0.697$, $p=0.025$), outperforming Traditional ATS ($\rho=0.552$),
MERIT (CV Only) ($\rho=0.515$), and the semantic baseline ($\rho=0.285$). Adding GitHub and LinkedIn raises $\rho$ from 0.515 to 0.697
...
Traditional ATS aligns best with $\rho=0.794$, followed by MERIT (Full) with $\rho=0.624$. Note the difference in $\rho$ between
