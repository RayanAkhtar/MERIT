...
For live LinkedIn ingestion tests, at most 30 profiles were retrieved via Apify; each belonged to a personal contact who gave informed consent for FYP use only (see Chapter~6). This approach is not intended for deployment.
In cases where anonymisation was not possible, data was stored securely using a reliable database provider (Supabase). 
...
All project source code, test cases, and supporting scripts are available within the project repository: \textit{https://github.com/RayanAkhtar/MERIT}. 
