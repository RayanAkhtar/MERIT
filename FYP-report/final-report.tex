...
% Evaluation table helpers (used across evaluation/*.tex and ethics/*.tex)
\newcommand{\merittablesize}{\small}
\newenvironment{merittabular}[1]{%
  \begin{tabular}{#1}%
}{%
  \end{tabular}%
}
...
% Light paragraph spacing (~1--2 extra pages). Comment out the next line for the original tight layout.
...
% Running header: chapter title inner with rule; page number bottom outer with rule
\setlength{\headheight}{14.5pt}
\setlength{\headsep}{12pt}
\fancypagestyle{main}{%
  \fancyhf{}%
  \fancyhead[RE,LO]{\small\bfseries\leftmark}%
