...
The main objective is to design and implement a multi-source screening system for recruiters, where this entails combining multiple data sources to see more details into a candidate and evaluate their technical proficiencies. 
