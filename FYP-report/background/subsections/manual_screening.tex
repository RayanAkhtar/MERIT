...
\label{sec:background-manual-screening}
...
but instead to reject candidates that are considered unsuitable for the role, 
...
\paragraph{Cognitive Overload and Fatigue}
A primary cause of bias stems from time pressure and superficial 
...
\paragraph{Psychological Heuristics and Distortions}
...
The consistency of the recruitment process is compromised by the contrast effect, as 
...
\paragraph{Systemic and In-Group Biases}
...
and ethnic discrimination is a key issue.
...
The biases mentioned uncover the inequality behind manual screening, more specifically the lack of consistency
