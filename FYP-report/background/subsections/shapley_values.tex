\section{Explainable AI via Shapley Values}
...
In other words, it is possible to determine whether a candidate got a high score due to self-reported claims on their CV, or from evidence-based metrics from a souorce, such as GitHub. 
