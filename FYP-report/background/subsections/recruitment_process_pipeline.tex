...
\end{tikzpicture}
\caption{Overview of a typical technical recruitment pipeline. Core stages are shown as solid boxes. Optional or organisation-dependent stages are dashed. The final outcome (job offer) is visually distinguished from other stages.}
...
This step is almost universal, with 93\% of companies conducting an initial CV screen as the first hiring step \cite{hackerrank2018recruiting}. 
...
Although many employers claim to value portfolios, such as GitHub, with 72.7\% listing it among in-demand qualifications, in practice, the initial screening mostly relies on CVs \cite{hackerrank2018skills}. 
...
\subsection{Online Behavioural Assessment} 
...
These tools, while uncommon in technical hiring, should also be considered as approximately 14\% of companies use behavioural games and 22\% use asynchronous video interviews \cite{talentboard2021}. 
Academic research also highlights the growing role of such digital and behavioural assessment methods, showing they can be used to assess candidates outside of their traditional CV data \cite{chamorro2016}. 
Smaller companies, however, rarely adopt such methods due to cost, limited perceived value and candidate-dropout risk.

\subsection{Online Technical Assessment}
...
HackerRank's research shows that online assessments are widely used in the technical hiring pipeline, and continue to be a central tool for screening candidates \cite{hackerrank2023skills}. 
Similarly, CodeSignal also highlight the growth in the adoption of these platforms as well as their role in standardising early-stage evaluations \cite{codesignal2022}.

\subsection{Live Behavioural Interview}
...
\subsection{Live Technical Interview}
...
This suggests that hiring pipelines should leverage alternative assessment methods as opposed to solely live coding rounds \cite{microsoft_hiring_broken}.

\subsection{Take Home Assignment}
...
According to LinkedIn, around 58\% of engineering hiring managers review code samples or project repositories when available \cite{linkedin2023_fos}. 
...
Recent data suggests that a minority of organisations (approximately 16\%) use formal assessment centres as part of their selection process \cite{cipd2022}. 
Here, they commonly evaluate soft skills, such as teamwork, communication, problem-solving and behavioural skills, often through group exercises, psychometric tests, role plays and combined tasks \cite{psychometricsuccess2023}. 
