...
To assess the detection of missing skills or weak areas, we will evaluate whether MERIT appropriately flags data gaps and weak competencies.
...
At least $80\%$ of relevant candidates should have their missing or weak skill areas correctly flagged.
...
We are attempting to extend the state of the art in three key areas: multi-source data integration, customisable scoring, and also explainability and transparency.
...
As well as this, recruiters must be able to adjust scoring to match role-specific priorities with different weightings meaningfully affecting results.
