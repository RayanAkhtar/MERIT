...
@job_reqs_bp.route("/get-job-descriptions", methods=["GET"])
...
@job_reqs_bp.route("/save-job-description", methods=["POST"])
...
@job_reqs_bp.route("/update-job-description/<id>", methods=["PUT"])
...
@job_reqs_bp.route("/delete-job-description/<id>", methods=["DELETE"])
